# Ergonomía para Profesionales de la Tecnología: Cómo Prevenir Dolor y Mejorar tu Salud en el Trabajo

[![](../../images/24-MiniaturaPodcast.jpg)](https://youtu.be/PJwqyAJ3NoI)

 - #### Alibaba lanza QwQ-32B, un modelo de IA de razonamiento que desafía a OpenAI
 - #### ElevenLabs lanza GenFM: IA generativa para crear podcasts multispeaker personalizados
 - #### Filtración de OpenAI Sora: Artista expone acceso a herramienta de IA secreta
 - #### Anthropic lanza MCP, un protocolo abierto para conectar asistentes de IA con sistemas de datos
